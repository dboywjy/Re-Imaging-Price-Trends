...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer6['target']
        self.path = config.trainer6['path']
        self.params = config.trainer6
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer6_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer6_CNN_classification_train_val_loss.png')
        plt.show()
