...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer5['target']
        self.path = config.trainer5['path']
        self.params = config.trainer5
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer5_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer5_CNN_classification_train_val_loss.png')
        plt.show()
