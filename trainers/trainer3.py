...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer3['target']
        self.path = config.trainer3['path']
        self.params = config.trainer3
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer3_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer3_CNN_classification_train_val_loss.png')
        plt.show()
