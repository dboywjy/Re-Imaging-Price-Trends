...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer4['target']
        self.path = config.trainer4['path']
        self.params = config.trainer4
    ...
    def model(self):
        model = CNN()
        model = initialize_parameters(model, 'relu') # Xavier init
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer4_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer4_CNN_classification_train_val_loss.png')
        plt.show()
