...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer7['target']
        self.path = config.trainer7['path']
        self.params = config.trainer7
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer7_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer7_CNN_classification_train_val_loss.png')
        plt.show()
