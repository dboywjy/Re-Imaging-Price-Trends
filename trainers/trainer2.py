...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer2['target']
        self.path = config.trainer2['path']
        self.params = config.trainer2
...
#         model = initialize_parameters(model, 'leaky_relu') # Xavier init
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer2_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer2_CNN_classification_train_val_loss.png')
        plt.show()
