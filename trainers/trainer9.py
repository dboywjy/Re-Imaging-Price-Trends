...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer9['target']
        self.path = config.trainer9['path']
        self.params = config.trainer9
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer9_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer9_CNN_classification_train_val_loss.png')
        plt.show()
