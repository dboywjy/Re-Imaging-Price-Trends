...
class Train():
    def __init__(self):
        ...
        self.target = config.trainer1['target']
        self.path = config.trainer1['path']
        self.params = config.trainer1
    ...
    def evaluate(self):
        ...
        plt.legend()
        plt.savefig('./reports/figures/trainer1_CNN_classification_loss.png')
        plt.show()
        ...
        plt.savefig('./reports/figures/trainer1_CNN_classification_train_val_loss.png')
        plt.show()
